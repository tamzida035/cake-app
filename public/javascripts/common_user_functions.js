...
const MIN_DISPLAY_NAME_LENGTH=6;// MINM length of displayed name
const MIN_PASSWORD_LENGTH=8;// MINM length of displayed name
...
const printH=function(error_field_name)
{
  //console.log("Hello");
  let error_msg_field=document.getElementById(error_field_name);
  error_msg_field.style.color="green";
  //set error message for this field
  error_msg_field.innerHTML="come on";
}
